...
class Train:
    def __init__(self, node_X, graph_dict, params):
        ...
        self.model = Model(self.params.cell_feat_dim, self.params).to(self.device)
    ...
    def process(self):
        self.model.eval()
        latent_z, _, _, de_feat, q, feat_x, gnn_z = self.model(self.node_X, self.adj_norm)
